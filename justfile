...
run:
  nu ~/private/lili1/scripts/nu/local.nu run
  ...
  kubectl create secret generic es-secret --from-file=creds=./tmp/gcp-credentials.json -n apps


  kubectl create secret generic es-secret --from-file=creds=./tmp/gcp-credentials.json -n crossplane-system
  kubectl create namespace aris
  kubectl create secret generic es-secret --from-file=creds=./tmp/gcp-credentials.json -n aris
